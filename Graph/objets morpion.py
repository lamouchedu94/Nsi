...
def main(dim) :
    ...
    j1 = Bouton((dim*3+dim//2, dim//3),(dim, dim//2),(255,255,255),"Joueur 1",(0,0,0))
    j1.draw(surf)
    j2 = Bouton((dim*3+dim//2, dim//3+dim),(dim, dim//2),(255,255,255),"Joueur 2",(0,0,0))
    j2.draw(surf)
    b3 = Bouton((dim*3+dim//2, dim//3+dim*2),(dim, dim//2),(255,255,255),"Commencer",(0,0,0))
    b3.draw(surf)
