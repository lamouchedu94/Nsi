...
with open("le-petit-prince--antoine-de-saint-exupery.txt","r") as file :
    chaine = file.read()
    file.close()

with open("avant.txt", "w") as file :
    file.write(chaine)
    file.close()

with open("avant.txt", "r") as file :
    chaine = file.read()
    file.close()
...
#print(dico)
with open("apres.txt","w") as file :
    file.write(chaine_decode)
    file.close()

def test_fichier(path1, path2) :
    with open(path1, "r") as file1 :
        texte_avant_compression = file1.read() 